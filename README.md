...
Push your completed repository for this session to GitHub, and then check your VM1 Site (http://YOURVM1NAMEHERE.net.dcs.hull.ac.uk/) using the browser, you should see your updated version now working in there! Screenshot this updated working version (including the link) and add this to your portfolio. (then push it again!).   
    </div>
</div>
